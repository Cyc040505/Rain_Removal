...
class FrequencyLoss(nn.Module):
    def __init__(self, epsilon=1e-3, amp_weight=1.0, phase_weight=0.5, consistency_weight=0.1):
...
class TotalLoss(nn.Module):
    def __init__(self, char_weight=1.0, edge_weight=0.05, freq_weight=0.05, freq_amp_weight=1.0, freq_phase_weight=0.5, freq_consistency_weight=0.1):
        ...
        self.freq_loss = FrequencyLoss(amp_weight=freq_amp_weight,
                                       phase_weight=freq_phase_weight,
                                       consistency_weight=freq_consistency_weight)
